...
| SITE-05 | P1 | Make all analytical views audience-layered | One density level cannot serve players, quants, and finance professionals simultaneously | Every material card/chart exposes plain headline, intuitive explanation, and expandable technical evidence; terminology is defined at first use; user can stay at the simple layer without losing the decision | `PLANNED` |
