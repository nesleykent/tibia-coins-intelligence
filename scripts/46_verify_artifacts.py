...
FACTS = [
    ...
    {"key": "hypothesis_tests", "scope": ("pdf", "hub"), "meta": "hypothesisTests",
     "value": F["testing_ledger"]["n_tests_total"],
     "kind": "number", "tol": 0,
     "pattern": r"([\d,]+) hypothesis tests",
     "why": "the size of the study's own multiple-testing problem, which both artifacts state"},
